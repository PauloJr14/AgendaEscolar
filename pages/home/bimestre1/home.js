        ...
        if (user) {
            ...
            collection.doc(user.uid).get().then((doc) => {
                if (doc.exists) {
                    ...
                    document.getElementById('cien1').value = data.cieb1n1 || '';
                    document.getElementById('cien2').value = data.cieb1n2 || '';
                    ...
                    if (Number(data.biob1n1) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.biob1n2) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.cieb1n1) !== 0) {
                        button1();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.cieb1n2) !== 0) {
                        button1();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.filb1n1) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.filb1n2) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.fisb1n1) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.fisb1n2) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.quib1n1) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.quib1n2) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.socb1n1) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    } else if (Number(data.socb1n2) !== 0) {
                        button2();
                        document.getElementById("div1").style.display = "none";
                    }
...
function salvar() {
	...
	if (user) {
		...
		var data = {
			...
			"cieb1n1": document.getElementById('cien1').value,
			"cieb1n2": document.getElementById('cien2').value,
